...
#################################################################################
def yolov5(pretrained=True, channels=3, classes=5, autoshape=True, verbose=True, device=None):
# YOLOv5-xlarge-P6 model https://github.com/ultralytics/yolov5
    return _create('yolov5', pretrained, channels, classes, autoshape, verbose, device)
